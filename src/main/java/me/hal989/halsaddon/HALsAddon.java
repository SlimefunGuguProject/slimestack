...
public class HALsAddon extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        CustomItemStack categoryItem = new CustomItemStack(Material.END_STONE, "&5Addon Jam: The End");
        ...
        BOSS_DROP = new RecipeType(new NamespacedKey(this, "boss_drop"), new CustomItemStack(Material.DIAMOND_SWORD, "&cBoss Drop"), null, "", "&rKill the specified Boss for a chance to obtain this Item");
...
//Endstone Tools
        ...
        ItemStack[] shulkerHead = {
                null, null, null,
                null, new CustomItemStack(SkullUtil.getByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjFkMzUzNGQyMWZlODQ5OTI2MmRlODdhZmZiZWFjNGQyNWZmZGUzNWM4YmRjYTA2OWU2MWUxNzg3ZmYyZiJ9fX0="), "&dShulker"), null,
                null, null, null //shulker drop for recipes
        };
        ItemStack[] endermegaDrop = {
                null, null, null,
                null, new CustomItemStack(SkullUtil.getByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmJjZjNmNTc4NzE5NmQyNTZjMTA0ZmZmYWU4ZTUyNjUyNDIyMjJlMjEzOGE1N2ExNjY2YzE1YjVmNmM4N2I5OCJ9fX0="), "&5Endermega"), null,
...
// End Bars & Fragments
        ...
        SlimefunItem EndFragment_item = new SlimefunItem(enderItemGroup, EndFragment, RecipeType.COMPRESSOR, EndFragment_recipe);
        ...
        SlimefunItem CompressedEndFragment_Item = new SlimefunItem(enderItemGroup, Compressed_EndFragment, RecipeType.COMPRESSOR, CompressedEndFragment_recipe);
        CompressedEndFragment_Item.register(this); //compressed end fragment
        SlimefunItem FrozenBar1_item = new SlimefunItem(enderItemGroup, FrozenBar_1, RecipeType.PRESSURE_CHAMBER, FrozenBar1_recipe);
